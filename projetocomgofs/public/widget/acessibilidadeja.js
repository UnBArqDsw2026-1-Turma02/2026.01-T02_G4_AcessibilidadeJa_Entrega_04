...
(function () {
  ...
  var WIDGET_CSS = (function () {
    ...
    return [
      ...
      /* Overlay */
      '.ajw-overlay{position:fixed;inset:0;background:rgba(0,0,0,.35);z-index:2147483646;',
      'opacity:0;pointer-events:none;transition:opacity .25s ease}',
      '.ajw-overlay.open{opacity:1;pointer-events:auto}',

      /* Painel */
      '.ajw-panel{position:fixed;top:0;' + (isRight ? 'right:0' : 'left:0') + ';',
      'height:100dvh;width:340px;max-width:90vw;background:#fff;color:#1a2a30;',
